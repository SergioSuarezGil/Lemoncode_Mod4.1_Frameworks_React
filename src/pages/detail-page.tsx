...
export const DetailPage: React.FC = () => {
  ...
  const [userDetail, setUserDetail] = React.useState<GitHubUserDetail | null>(null);
  ...
  React.useEffect(() => {
    const loadUserDetail = async () => {
      ...
      try {
        ...
        setUserDetail(null);
        setErrorMessage(error instanceof Error ? error.message : 'Se produjo un error inesperado.');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <section className='detail-page'>
      <div className='detail-page__card'>
        ...
        {!isLoading && errorMessage && <p className='detail-page__text detail-page__text--error'>{errorMessage}</p>}

        {!isLoading && userDetail ? (
          <div className='detail-page__content'>
            <img className='detail-page__avatar' src={userDetail.avatar_url} alt={userDetail.login} />

            <div className='detail-page__info'>
              <p className='detail-page__text detail-page__text--highlight'>@{userDetail.login}</p>
